...
import { ScrollArea } from "@/components/ui/scroll-area"; // Pas de .Viewport dispo
...
const AIAssistant = () => {
  ...
  // Ref vers le composant ScrollArea
  const scrollAreaRef = useRef<HTMLDivElement | null>(null);

  const scrollToBottom = () => {
    if (!scrollAreaRef.current) return;

    // Récupérer le viewport via data-radix-scroll-area-viewport
